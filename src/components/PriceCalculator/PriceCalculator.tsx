...
const PriceCalculator = () => {
  ...
  return (
    <div className="flex justify-center items-center gap-2 bg-gray-700 text-gray-200 p-2 rounded-2xl">
      ...
      <input
        className="text-base text-black text-center p-2 rounded-md w-24 border-2 border-gray-500 bg-gray-400 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
        type="number"
