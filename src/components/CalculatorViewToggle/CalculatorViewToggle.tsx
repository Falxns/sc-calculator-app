...
const CalculatorViewToggle = ({ value, onChange }: CalculatorViewToggleProps) => {
  ...
  const modes: { id: CalculatorViewMode; labelKey: 'calc.listView' | 'calc.gridView'; Icon: typeof ListIcon }[] = [
    { id: 'list', labelKey: 'calc.listView', Icon: ListIcon },
    { id: 'grid', labelKey: 'calc.gridView', Icon: GridIcon },
  ];
        ...
        return (
          ...
          >
            ...
            <span className="hidden sm:inline">
              {id === 'list' ? t('calc.list') : t('calc.grid')}
            </span>
          </button>
        );
      })}
